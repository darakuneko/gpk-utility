...
> 参照先: [主仕様書](./vial_firmware_integration.md),
> [付録A: パケット](./vial_firmware_appendix_a_packets.md),
> [付録B: デバイスマトリクス](./vial_firmware_appendix_b_device_matrix.md)
...
- [ ] `config/device_config.h` を作成
  ...
  - [ ] `id_device_operation_t` enum (0x01–0x02)
  - [ ] 関数プロトタイプ宣言
- [ ] `config/device_config.c` を作成
